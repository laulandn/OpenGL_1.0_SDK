...
void	movetl(muiTextList *tl, int ymin, int ymax)
{
...
muiTextList	*newtl(muiObject *obj, int listheight)
{
    muiTextList	*tl;

    tl = (muiTextList *)malloc(sizeof(muiTextList));
...
{
    muiTextList *tl = (muiTextList *)obj->object;
